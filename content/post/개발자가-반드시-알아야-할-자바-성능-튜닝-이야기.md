...
### 32쪽
> nanoTime() 메서드를 만든 목적은 수행된 시간 측정이기 때문에 오늘의 날짜를 알아내는 부분에는 사용하면 안 된다.

### 157쪽
> JDK5부터는 -XX:+UseBiasedLocking라는 옵션을 통해서 biased lock이라는 기능을 제공한다.
...
### 358쪽
GC로그 분석 툴 소개. HPJmeter는 아파치의 JMeter와는 전혀 상관이 없는 모니터링 및 분석툴.
