...
- <http://www.opentext.com/> : CMS 솔루션
- <http://mesh.com> : 각종 디바이스 동기화, 원격 제어
- 클라우드 관리 솔루션 : <http://enstratus.com/>, <http://www.rightscale.com/>
...
### p24
> 클라우드 인프라스트럭처에서 생명 주기가 긴 노드가 필요한 시스템이 겪는 어려움은 
...
### p168
침입탐지에 쓰이는 OSSEC (https://www.ossec.net/)
